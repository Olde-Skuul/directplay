...
//-----------------------------------------------------------------------------
#ifndef __CGRPTREE_H__
#define __CGRPTREE_H__
...
// Images
enum {
	IMG_SHORTCUT_OVERLAY = 0,
	IMG_GROUP,
	IMG_HIDDEN_GROUP,
	IMG_HIDDEN_GROUP_SELECTED,
	IMG_HIDDEN_STAGING_AREA_IN_PROGRESS,
	IMG_HIDDEN_STAGING_AREA,
	IMG_GROUP_SELECTED,
	IMG_PLAYER,
	IMG_STAGING_AREA_IN_PROGRESS,
	IMG_SPECTATOR,
	IMG_STAGING_AREA,
	IMG_OWNER_OVERLAY
};
...
private:
	...
	HMENU m_hMenu, m_hRootMenu, m_hGroupMenu, m_hPlayerMenu, m_hShortcutMenu,
...
private:
	HTREEITEM FindItem(HTREEITEM htiSearchRoot, DPID dpidTarget, BRANCH_TYPE bt,
		DWORD dwSearch);
	HTREEITEM Insert(HTREEITEM htiParent, DPID dpID, LPSTR lpShortNameA,
		BRANCH_TYPE bt, DWORD dwFlags);
	HRESULT RecursiveRename(
		HTREEITEM htiSearchRoot, DPID dpidTarget, LPSTR lpszName);
...
public:
	...
	HRESULT CreateGroupInGroup(DPID dpidParentGroup, DPID dpidChildGroup,
		LPSTR lpszShortNameA, DWORD dwFlags);
