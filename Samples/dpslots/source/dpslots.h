...
#define SECURESENDFLAGS (DPSEND_GUARANTEED | DPSEND_SIGNED | DPSEND_ENCRYPTED)
#define SENDFLAGS(bIsSecure) \
	((bIsSecure) ? SECURESENDFLAGS : NONSECURESENDFLAGS)

// Flags to use when creating sessions
#define NONSECURESESSIONFLAGS (DPSESSION_KEEPALIVE | DPSESSION_CLIENTSERVER)
#define SECURESESSIONFLAGS \
	(DPSESSION_KEEPALIVE | DPSESSION_CLIENTSERVER | DPSESSION_SECURESERVER)
#define SESSIONFLAGS(bIsSecure) \
	((bIsSecure) ? SECURESESSIONFLAGS : NONSECURESESSIONFLAGS)
...
DEFINE_GUID(DPSLOTS_GUID, 0xec4f7aa0, 0xe1e0, 0x11d0, 0x9c, 0x50, 0x0, 0xa0,
	0xc9, 0x5, 0x42, 0x5e);
