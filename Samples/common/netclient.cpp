    ...
    if( strIPAddress != NULL && strIPAddress[0] != 0 )
    {
        ...
        if( NULL != strPort )
        {
            ...
            *strEndOfIP = 0;
            ...
            strPort++;
            dwPort = static_cast<DWORD>(_ttoi( strPort ));
        }
    ...
    if( pDPHostEnum != &m_DPHostEnumHead )
    {
        ...
        while ( pDPHostEnum != &m_DPHostEnumHead )
        {
            ...
            if( pDPHostEnum->bValid )
            {
                ...
                SendMessage( hWndListBox, LB_SETITEMDATA, (WPARAM)nIndex, (LPARAM)pDPHostEnum );
                ...
                if( bFindSelectedGUID )
                {
                    ...
                    {
                        SendMessage( hWndListBox, LB_SETCURSEL, (WPARAM)nIndex, 0 );
