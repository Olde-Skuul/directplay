...
GUID g_guidApp = {0xfcd4761e, 0x2b9c, 0x4478,
	{0xb7, 0xea, 0xd9, 0xe1, 0x8e, 0x6e, 0x2a, 0xac}};
	...
	LPVOID lpvUserContext, DWORD dwMessageType, LPVOID lpMessage)
{
	...
	case DVMSGID_CREATEVOICEPLAYER: {
		...
		PLAYER_ADDREF(
			pPlayerInfo); // addref player, to be used by the voice layer
		PLAYER_UNLOCK();  // leave player context CS
	...
	LPSTR /* pCmdLine */, INT /* nCmdShow */)
{
	...
	if (bConnectSuccess) {
		...
		DialogBox(hInst, MAKEINTRESOURCE(IDD_VOICE_SETUP), NULL,
