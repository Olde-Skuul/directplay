...
public:
	...
	// From IMazeGraphics
	virtual VOID Init(CMazeApp* pMazeApp, CDPlay8Client* pDP8Client,
...
protected:
	static INT_PTR CALLBACK StaticSaverConfigDlgProc(
		HWND hDlg, UINT uMsg, WPARAM wParam, LPARAM lParam);
	INT_PTR CALLBACK SaverConfigDlgProc(
		HWND hDlg, UINT uMsg, WPARAM wParam, LPARAM lParam);
