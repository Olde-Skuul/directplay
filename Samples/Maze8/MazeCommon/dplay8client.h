...
protected:
	...
	BOOL EnumSessionCallback(const DPN_APPLICATION_DESC* pdesc,
		IDirectPlay8Address* pDP8AddressHost,
		IDirectPlay8Address* pDP8AddressDevice);
	static HRESULT WINAPI StaticReceiveHandler(
		void* pvContext, DWORD dwMessageType, void* pvMessage);
	HRESULT WINAPI ReceiveHandler(
		void* pvContext, DWORD dwMessageType, void* pvMessage);
