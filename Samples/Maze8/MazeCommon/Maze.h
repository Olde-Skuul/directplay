...
//-----------------------------------------------------------------------------
// Name:
// Desc: Client IDs are 32-bit values that refer to a particular Client. They
// are
...
const BYTE MAZE_WALL_ALL =
	MAZE_WALL_NORTH | MAZE_WALL_EAST | MAZE_WALL_SOUTH | MAZE_WALL_WEST;
...
public:
	...
	// Get list of visible cells from the given position. Fills out the list
	// pointed to be plist, and stops if it blows maxlist. Returns number of
	// visible cells
...
protected:
	...
	void RecurseCheckCellVis(
		VisState& state, DWORD x, DWORD y, D3DXVECTOR2 left, D3DXVECTOR2 right);
	BYTE ComputeVisFlags(const D3DXVECTOR2& dir, const D3DXVECTOR2& left,
