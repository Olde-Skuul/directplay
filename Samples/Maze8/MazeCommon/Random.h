...
public:
	...
	// The default values for a,b,m give a maximal period generator that does
	// not overflow with 32-bit interger arithmetic.
	CRandom(
		DWORD seed = 31415, DWORD a = 8121, DWORD b = 28411, DWORD m = 134456):
