...
#define NS_S_LOBBYCONNECT \
	0x01000004 // Dialog connected from lobby, connect success
#define NS_S_REJECTED \
	0x01000005 // The player was rejected from the game, so
...
protected:
	struct SLOT_INFO {
		...
		TCHAR strSlotName[MAX_PLAYER_NAME]; // String name associated with this
											// slot
	...
	HRESULT HandleAppMessages(
		HWND hDlg, STAGEMSG_GENERIC* pMsg, PDPNMSG_RECEIVE pReceiveMsg);
